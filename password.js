...
var passwordCheckOld = function () 
{
    ...
    stringOutput = "";
    var stringBadYes = "This password is on a list of bad passwords.";
    var stringBadNo = "This password is not on a list of bad passwords.";
    var stringShort = "The password is too short, it must be at least 8 characters.";
    var stringLong = "The password length is strong.";
    
   if(n >= 8 && arrayBadPasswords.includes(stringPassword))
   {
      $("output").value = stringLong + " " + stringBadYes;
   }
   
   if(n < 8 && arrayBadPasswords.includes(stringPassword))
   {
      $("output").value = stringShort + " " + stringBadYes;
   }
   
   if(n < 8 && arrayBadPasswords.includes(stringPassword)==false)
   {
      $("output").value = stringShort + " " + stringBadNo;
   }
   
   if(n >= 8 && arrayBadPasswords.includes(stringPassword)==false)
   {
      $("output").value = stringLong + " " + stringBadNo;
   }
